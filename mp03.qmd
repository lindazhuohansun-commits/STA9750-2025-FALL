...
Second, the [NYC Forestry Tree Points](https://data.cityofnewyork.us/Environment/Forestry-Tree-Points/hn5i-inap/about_data) dataset was retrieved from NYC Open Data, containing detailed information on each tree’s species, health condition, and precise geographic location.
...
This map shows the density of trees across NYC Council Districts. While District 51 has the most trees overall,The highest tree density is in Council District **`r dens_row$CounDist`** at **`r round(dens_row$tree_density * 1e6)`** trees per km².they contain many trees within a limited land area.
...
Based on spatial distance calculations, the tree closest to Baruch College’s main campus 
(40.7403° N, −73.9833° W) is identified as **`r closest_tree$genusspecies`**, 
